...
const RoundWaveBtn = styled.button`
    ...
    color: #5B5B5B;    
    width: ${(props: Props): string | number=> {return props.width;}};
    height: ${(props: Props): string | number=> {return props.height;}};
    outline-color: #EA4C89;
    outline-style: solid;
    outline-width: ${(props: StyledProps): string => {return props.state === "entered" ? "5px" : "1px"; }};
    outline-offset: ${(props: StyledProps): string => { return props.state === "exited" ? "0px": "10px";}};
`;
